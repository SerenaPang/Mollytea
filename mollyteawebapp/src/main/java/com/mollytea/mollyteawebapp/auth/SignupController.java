...
class SignupController {
    ...
    ModelAndView signup(Principal principal) {
        ...
        return new ModelAndView("signup", Map.of("phone", principal == null ? "" : principal.getName()));
    }

    @PostMapping
    String signup(String phone, String password, String addressLine1, String addressLine2, String postcode) {
        if (this.signupService.accountExists(phone)) {
            return "redirect:/login";
        }

        this.signupService.register(phone, password, addressLine1, addressLine2, postcode);
